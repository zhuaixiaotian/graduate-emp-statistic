        ...
        <section class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-input-inline">
              <select name="companyId" readonly></select>
            </div>
          </div>
          <div class="layui-inline">
            <div class="layui-input-inline">
              <input class="layui-input" name="jobName" placeholder="按岗位名称模糊检索"/>
            </div>
            <div class="layui-input-inline">
...
<script type="text/javascript" src="${rc.contextPath}/resources/js/enterprise/job/manage.js"></script>
</body>
</html>
